...
\begin{tikzpicture}
    ...
    \draw[fill = black] (2,0) \v (2.5, 0) \v (2.25,.4) \v (3,0) \v (2.75,.4) \v (2.5, .8) \v;
    \draw[fill = black] (4,0) \v (4.5, 0) \v (4.25,.4) \v (5,0) \v (4.75,.4) \v (4.5, .8) \v (5.5, 0) \v (5.25, .4) \v (5, .8) \v (4.75, 1.2) \v;
    \end{tikzpicture}
%
%  $n = 0$
%  \end{center}
